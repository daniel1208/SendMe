...
namespace Layout
{
    ...
    public class MonoFlat_CheckBox : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (Enabled == true)
            {
                if (_Checked)
                {
                    G.DrawString("a", new Font("Marlett", 16), new SolidBrush(Color.FromArgb(0, 150, 250)), new Point(-5, -3));
                }
            }
            else
            {
            ...
            G.DrawString(Text, Font, new SolidBrush(Color.White), new Point(20, 0));
        }
    }
    #endregion
    #region  Radio Button
    ...
    public class MonoFlat_TextBox : Control
    {
        ...
        {
            P1 = new Pen(Color.FromArgb(0, 182, 152));
            Refresh();
        }
